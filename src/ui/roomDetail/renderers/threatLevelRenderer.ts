import { RoomDetailsData, RoomThreatLevelEnum, DifficultyLevel } from 'src/data';
 ...
 */
export function setThreatLevel(room: RoomDetailsData, difficulty: DifficultyLevel) {
    ...
    document.querySelectorAll('.room-threat-level').forEach((roomThreatLevelEl) => {
